...
// TUSHY Made some changes for generating different tables.

#define TB_FILE   	"CrcTable.h"
#define TB_WIDTH	2
#define TB_POLY 	0x11021
...
LOCAL void chkparam ()
{
 ...
 //if ((TB_WIDTH == 2) && (TB_POLY & 0xFFFF0000L))
    //chk_err("chkparam: Poly parameter is too wide."); // TUSHY Commented this out.
 ...
 switch (TB_WIDTH)
   {
    ...
    default: chk_err("gentable: TB_WIDTH is invalid."); break;
   }
 chk_err("");
